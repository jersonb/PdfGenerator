...
namespace PdfGenerator.Documents
{
    internal class EspecificDocument : GenericDocument
    {
        ...
        internal MemoryStream GetPdf()
        {
            ...
            pdfElemment.Table(LabelNameTableValue.VALOR_DIA, titles,content);
            pdfElemment.Table(LabelNameTableValue.VALOR_SERVICO, titles,content);
            Test();
            pdfElemment.Table(LabelNameTableValue.VALOR_DIA, titles, content);
            pdfElemment.Table(LabelNameTableValue.VALOR_SERVICO, titles, content);
            Test();
